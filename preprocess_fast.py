...
class PreProcessVideos:
    ...
    def load_blip(self):
        ...
        processor = Blip2Processor.from_pretrained("Salesforce/blip2-opt-2.7b", cache_dir="/nlp/scr/demiguo/explore/cache")

        print("Loaded processor")

        model = Blip2ForConditionalGeneration.from_pretrained(
            "Salesforce/blip2-opt-2.7b", torch_dtype=torch.float16, cache_dir="/nlp/scr/demiguo/expore/cache",
        )
        print("Loaded model")
